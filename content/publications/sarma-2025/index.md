...
- Soumyadeep Sarma
date: '2025-01-01'
publishDate: '2025-11-09T09:37:01.499238Z'
publication_types:
- article-journal
publication: '*JphysA: Math. and Theor.*'
...
Finally, the formalism developed in this project can be readily extended to higher values of k in the k by L strip, which can be then used to readily study the system of trimers on a 2D lattice. The work has been published in Journal of Physics A: Mathematical and Theoretical (https://iopscience.iop.org/article/10.1088/1751-8121/adc9e8/meta) and the open access version on arxiv is https://arxiv.org/abs/2409.07744
